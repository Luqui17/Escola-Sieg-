            ...
            <div class="collapse navbar-collapse" id="conteudoNavbarSuportado">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="TelaCadastro.aspx">Cadastrar <span class="sr-only">(página
                                atual)</span></a>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="card-body">
                            ...
                            <form runat="server" method="post">
                                ...
                                <div class="form-group" runat="server">
                                    ...
                                    <input class="form-control" type="date" name="txbData" id="data"
                                        placeholder="Insira a Data de Nascimento" runat="server" required /><br />
                                </div>
                                <div class="form-group" runat="server">
                                ...
                                <div>
                                    ...
                                    <input class="form-control" type="text" name="txbTurma" id="turma"
                                        placeholder="Digite a turma" runat="server" required />
                                </div>
